...
\hypersetup{
  ...
  pdfauthor={James Bartlett1 \& Gaby Mahrholz1},
  pdflang={en-EN},
...
\author{James Bartlett\textsuperscript{1} \& Gaby Mahrholz\textsuperscript{1}}
\date{}
...
The authors made the following contributions. James Bartlett: Conceptualization, Writing - Original Draft Preparation, Writing - Review \& Editing; Gaby Mahrholz: Writing - Review \& Editing.
...
Students in the error-full lecture performed significantly better on the data skills assignment than students in the error-free lecture, \(\Delta M = -4.94\), 95\% CI \([-7.49, -2.40]\).
